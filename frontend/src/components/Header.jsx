      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Button variant="ghost" className="flex items-center" onClick={() => setShowNearbyStores(true)}>
          ...
          {/* Right Actions */}
          <div className="flex items-center space-x-4">
            <Button variant="ghost" size="sm" className="hidden sm:flex"><Heart className="h-5 w-5" /></Button>
            <Button variant="ghost" size="sm" className="hidden sm:flex"><User className="h-5 w-5" /></Button>
        ...
        <div className="lg:hidden fixed inset-0 z-50 flex">
          <div className="w-72 h-screen bg-white border-r border-gray-200 shadow-lg flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-2">
              <Button variant="ghost" className="w-full justify-start" onClick={() => {navigate("/"); setIsMenuOpen(false);}}>
                Home
              </Button>
                  ...
                  <div className="pl-6 space-y-1">
                    {categories.map((c) => (
                      <Button
                        ...
                        variant="ghost"
                        className="w-full justify-start text-sm"
                        onClick={() => {navigate(`/category/${c.slug}`); setIsMenuOpen(false);}}
                      >
                        {c.name}
                      </Button>
                    ))}
              ...
              <Button variant="ghost" className="w-full justify-start" onClick={() => {navigate("/blog"); setIsMenuOpen(false);}}>
                Blog
              </Button>
              <Button variant="ghost" className="w-full justify-start" onClick={() => {setShowNearbyStores(true); setIsMenuOpen(false);}}>
                <MapPin className="h-4 w-4 mr-2" />
                Nearby Stores
              </Button>
          ...
          {/* Overlay */}
          <div className="flex-1 bg-black/30" onClick={() => setIsMenuOpen(false)} />
        </div>
      )}

      <NearbyStores isOpen={showNearbyStores} onClose={() => setShowNearbyStores(false)} />
    </header>
  );
};
