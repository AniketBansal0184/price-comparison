...
// import { getProducts, getCategories, getBlogs } from "../services/api";
...
//       setCategoriesList(cats.filter(c => c.parent === 0));
//       setBlogList(blogs);
//     } catch (err) {
//       console.error(err);
//     }
...
//   const featuredCategories = categoriesList;
//   const recentPosts = blogList;

//   const scrollProductsLeft = () => {
//     document
//       .getElementById("trending-products")
...
//               onClick={() =>
//                 document
//                   .getElementById("categories-slider")
//                   .scrollBy({ left: -300, behavior: "smooth" })
//               }
...
//               <Card
//                 key={category.id}
//                 className="flex-none w-64 group cursor-pointer border-0 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-gray-50 to-white"
